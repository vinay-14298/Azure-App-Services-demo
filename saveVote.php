...
<html lang="en">
  ...
  <body>
    ...
    <div class="container" style="padding-top:150px;">
       ...
       $DB_HOST= "35.184.83.131";
       $DB_USER="root";
       $DB_PASSWORD="vinayadmin";
       $DB_NAME="db_evoting";
        ...
        or die("Couldn't Connect to Database :");
				...
				if(mysqli_query($conn, $sql)){
					...
					echo "<a href='logout.php' class='btn btn-primary'> <span class='glyphicon glyphicon-ok'></span> <strong> Finish & Logout</strong> </a>";
				}
				else
				{
